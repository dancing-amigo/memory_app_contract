...
## 6. Read through search, context, or ask
...
- `context`: return a ContextPack when the app wants evidence, provenance, and retrieval trace for its own answerer or tools.
